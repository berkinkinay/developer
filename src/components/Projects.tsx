        ...
        <div class='flex flex-col items-center justify-center'>
          <div 
            class='2xl:!grid 2xl:!grid-cols-2 lg:!grid lg:!grid-cols-2 md:!flex md:flex-col md:!gap-48
                   xs:flex xs:flex-col xs:gap-36 place-items-center w-auto h-auto bg-black !gap-20'
          > 
             {projectsData.map((project, i) =>
                ...
                />
                    <motion.div
                      ...
                      class='flex absolute z-50 justify-center items-center h-64 2xl:w-[500px] lg:w-auto
                             bg-blue text-white bg-black bg-opacity-70 rounded-lg'
                    >
                        ...
                        <div class="flex gap-3">
                          <button
                            class='text-sm text-center p-2 bg-black text-red rounded-lg hover:bg-blue
                                  hover:text-pink-500 transition duration-100 cursor-pointer'
